...
import os
from paypal.extra_code_or_config.getIP import \
    appendIPToArray
...
ALLOWED_HOSTS = ["localhost",
                 "127.0.0.1",
                 "django-paypal.7t021jc3146ps.eu-west-1.cs.amazonlightsail.com", # lightsail
                 "contpaypal-env.eba-mmwrva77.eu-west-1.elasticbeanstalk.com"] # elastic beanstalk
...
TEMPLATES = [
    {
        ...
        'DIRS': ["paypal/templates/"],         # MJW Update
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# mjw - necessary to get collect static to look in paypal dir
STATICFILES_DIRS = [
    './paypal/static/',
]
